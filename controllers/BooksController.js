...
exports.GetBooksList = (req, res, next) => {
  Books.findAll({include:[{model: Categories}, {model: Authors}, {model: Editorials}]})
    .then((result) => {
...
exports.PostCreateBooks = (req, res, next) => {
  ...
  Books.create({ name: bookName, image: image, categoryId: bookCategories, authorId: bookAuthors, editorialId: bookEditorials, pubDate: pubDate})
    .then((result) => {
      res.redirect("/");
    })
    .catch((err) => {
...
exports.PostEditBooks = (req, res, next) => {
    ...
    Books.update({name: bookName, image: image, categoryId: bookCategories, authorId: bookAuthors, editorialId: bookEditorials, pubDate: pubDate}, {where: {id: bookId }})
    .then((result) => {
...
exports.PostBooksBySearch = (req, res, next) => {
  ...
  Books.findAll({include:[{model: Categories}, {model: Authors}, {model: Editorials}], where: {name: search}})
    .then((result) => {
